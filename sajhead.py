...
def threshfun(im):
    ...
    cv2.drawContours(mask, largest_areas, 1, (255,255,255), -1)
...
def head(im):
    ...
    dilation = cv2.dilate(th3n,kernel,iterations = 3)
    ...
    for c in cnt:
        ...
        x,y,w,h = rect
        b.append([x,y,w,h])
    _,cont, _ = cv2.findContours(th3n, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
    f=[]
