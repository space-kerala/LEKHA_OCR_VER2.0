...
setup(
    ...
    author_email="",
    url='https://github.com/space-kerala/LEKHA_OCR_VER2.0.git',
    download_url='https://github.com/space-kerala',
    keywords=['lekha malayalam ocr','lekha ocr version 2.0', 'malayalam image to text convertor','malayalam text from image'],
    packages=['lekha_ocr'],
    classifiers=[],
